...
import { AlexMorningBriefing, type BriefingAction } from '@/components/AlexMorningBriefing';
...
function EmployerDashboardContent() {
  ...
  // Drives the Alex Morning Briefing only — no other UI consumes this query.
  ...
  const briefingActions = dashboardData?.priorityActions ?? [];
  ...
  return (
    <div className="space-y-6">
      <AlexMorningBriefing actions={briefingActions} />
